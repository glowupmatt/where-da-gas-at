...
#         assert isinstance(review_data["text"], str)
...
#         single_review = detail_data["text"][str(review_id)]
#         assert single_review["id"] == int(review_id)
#         assert single_review["text"] == review["text"]
...
#     review_data = {
#         "text": "Great place for premium gas, but the line can get long during rush hour.",
#         "station_id": 1,
#     }
